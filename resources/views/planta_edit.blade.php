...
@section('content')
  ...
  <div
    ...
    <form action="{{ route('plantas.update', ['planta' => $planta->id]) }}" method="POST" enctype="multipart/form-data"
    id="formPlanta" class="space-y-4">
    @csrf
    @method('PUT')
    ...
    <div>
      ...
      <div id="previewContainer" class="mt-3">
        <img id="imagePreview" src="{{ $planta->foto ? asset('storage/' . $planta->foto) : '#' }}"
        alt="Pré-visualização" class="mx-auto max-h-40 rounded-md border border-green-200" @if(!$planta->foto)
